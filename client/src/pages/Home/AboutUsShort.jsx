    ...
    <section>
        <div className=" flex flex-col lg:grid grid-cols-2 pt-4">
            ...
            <div className=" flex flex-col p-12  bg-white text-black place-content-between">
                ...
                <button className=" bg-black text-white hover:bg-blue-500 self-center lg:self-start text-base mt-4 lg:mt-0 py-1 rounded-3xl w-32" onClick={handleMoreInfo}>MORE INFO</button>
            </div>
